...
export default function PageContent(props) {
  ...
  const discussLink = props.spectrumUrl ? (
    <AsideLink href={props.spectrumUrl}>
      <IconComment /> Discuss on Spectrum
    </AsideLink>
  ) : null
  ...
  return (
    <Wrapper>
      <InnerWrapper>
        ...
        <LinkContainer>{editLink}</LinkContainer>
        <LinkContainer>{requestLink}</LinkContainer>
        {props.spectrumUrl && <LinkContainer>{discussLink}</LinkContainer>}
        <PageNav
